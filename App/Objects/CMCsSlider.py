...
class CMCsPlots:
    def __init__(self, **kwargs):
        ...
        self.experiment_ids = next(os.walk('./generated/experiments/CMC/'))[1]
    ...
    def build_plot_list(self):
        plots = []
        base = './generated/experiments/CMC/' + self.experiment_ids[self.experiment_pointer] + '/'

        for filename in glob.glob(base + '/*.png'):
            plots.append(filename.replace('./generated/experiments/CMC/' + self.experiment_ids[self.experiment_pointer] , ''))
    ...
    def get_image_path(self):
        return './generated/experiments/CMC/' + self.experiment_ids[self.experiment_pointer] + '/' + self.plots_list[self.current_plot_index]
